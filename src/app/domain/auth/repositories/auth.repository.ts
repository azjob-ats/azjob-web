...
export abstract class AuthRepository {
    ...
    public abstract signInWithEmailAndPassword(email: string, password: string): Observable<ApiResponse>;

    public abstract signUpWithEmailAndPassword(user: UserRegisterWithEmailAndPassword): Observable<ApiResponse>;
    ...
    public abstract updatePasswordByToken(email: string, token: string, newPassword: string): Observable<ApiResponse>;
