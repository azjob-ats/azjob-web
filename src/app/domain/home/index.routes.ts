    ...
    children: [
      {
        ...
        loadComponent: () =>
          import('@domain/for-you/pages/app.component').then(m => m.AppComponent),
        children: [
          {
            path: '',
        ...
        children: [
          {
            path: '',
            loadChildren: () =>
              import('@domain/application/index.routes').then(m => m.INDEX_ROUTES),
          },
        ],
        ...
        children: [
          {
            path: '',
            loadChildren: () =>
              import('@domain/notification/index.routes').then(m => m.INDEX_ROUTES),
          },
        ],
